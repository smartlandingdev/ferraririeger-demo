...
function LandingPage() {
  const officeImages = [
    { src: '/assets/escritorio/09.jpg', title: 'Fachada', description: 'Nossa Estrutura' },
    { src: '/assets/escritorio/01.jpg', title: 'Recepção', description: 'Nossa Estrutura' },
    { src: '/assets/escritorio/02.jpg', title: 'Recepção', description: 'Nossa Estrutura' },
    { src: '/assets/escritorio/03.jpg', title: 'Recepção', description: 'Nossa Estrutura' },
    { src: '/assets/escritorio/04.jpg', title: 'Sala de Reunião', description: 'Nossa Estrutura' },
    { src: '/assets/escritorio/05.jpg', title: 'Escritório', description: 'Nossa Estrutura' },
    { src: '/assets/escritorio/06.jpg', title: 'Escritório', description: 'Nossa Estrutura' },
    { src: '/assets/escritorio/07.jpg', title: 'Escritório', description: 'Nossa Estrutura' },
    { src: '/assets/escritorio/08.jpg', title: 'Escritório', description: 'Nossa Estrutura' },
  ]
  ...
  return (
    <div className="landing-page">
      ...
      <nav className="navbar">
        <div className="navbar-content">
          ...
          <div className="navbar-menu">
            ...
            <a href="/corpo-juridico" className="nav-link">Corpo Jurídico</a>
        ...
        <div className="hero-container">
          <div className="hero-content">
            <div className="hero-badge">
              <img src={logo} alt="Ferrari & Rieger" className="badge-icon" />
            ...
            <div className="hero-actions">
              ...
              <a href="https://www.instagram.com/ferraririegeradv/" target="_blank" rel="noopener noreferrer" className="hero-btn hero-btn-secondary">
      ...
      <section className="office" id="office">
        <div className="container">
          ...
          <div className="office-gallery-container">
            ...
            <div className="office-instagram-overlay">
              <a href="https://www.instagram.com/ferraririegeradv/" target="_blank" rel="noopener noreferrer" className="instagram-btn-overlay">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/>
                </svg>
            ...
            <div className="contact-info">
              ...
              <div className="contact-methods">
                ...
                <div className="contact-item">
                  ...
                  <div className="contact-details">
                    <h4>Telefones Cascavel</h4>
                    <a href="tel:+554533063090">(45) 3306-3090</a>
              ...
              <div className="contact-cta">
                <a href="https://wa.me/5545999853090?text=Ol%C3%A1!%20Vim%20pelo%20site%20e%20gostaria%20de%20saber%20mais%20sobre%20os%20servi%C3%A7os%20jur%C3%ADdicos%20da%20Ferrari%20%26%20Rieger%20Advogados." target="_blank" rel="noopener noreferrer" className="btn-whatsapp">
              ...
              <div className="contact-card">
                ...
                <div className="card-content">
                  <div className="card-icon">
                    <img src={logo} alt="Ferrari & Rieger" className="card-logo" />
                  </div>
      ...
      {/* WhatsApp Button */}
      <a href="https://wa.me/5545999853090?text=Ol%C3%A1!%20Vim%20pelo%20site%20e%20gostaria%20de%20saber%20mais%20sobre%20os%20servi%C3%A7os%20jur%C3%ADdicos%20da%20Ferrari%20%26%20Rieger%20Advogados." target="_blank" rel="noopener noreferrer" className="scroll-to-top whatsapp-float" aria-label="Fale conosco no WhatsApp">
